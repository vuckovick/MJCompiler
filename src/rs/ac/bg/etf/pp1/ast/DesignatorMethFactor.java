...
public class DesignatorMethFactor extends Factor {

    private Designator Designator;
    private OptionalActPars OptionalActPars;

    public DesignatorMethFactor (Designator Designator, OptionalActPars OptionalActPars) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorMethFactor(\n");
