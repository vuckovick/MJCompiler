...
public class UnionStmtDoWhile extends DesignatorOrExprWhile {

    private Designator Designator;
    private Setop Setop;
    private Designator Designator1;

    public UnionStmtDoWhile (Designator Designator, Setop Setop, Designator Designator1) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("UnionStmtDoWhile(\n");
